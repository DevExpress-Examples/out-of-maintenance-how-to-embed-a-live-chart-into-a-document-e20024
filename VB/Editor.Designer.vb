...
Namespace BizPad
	Partial Public Class Editor
		...
		Private Sub InitializeComponent()
			...
			Me.ribbonControl.MaxItemId = 161
			...
			' homeRibbonPage1
			' 
			Me.homeRibbonPage1.Groups.AddRange(New DevExpress.XtraBars.Ribbon.RibbonPageGroup() { Me.clipboardRibbonPageGroup1, Me.editingRibbonPageGroup1})
